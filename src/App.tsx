...
export default function App() {
  ...
  const [offlineTwoPlayer, setOfflineTwoPlayer] = useState<{ rounds: number } | null>(null);
  ...
  if (offlineTwoPlayer) {
    return (
      <div className="min-h-screen bg-slate-50 antialiased font-sans">
        ...
        <main className="py-6">
          <OfflineTwoPlayer
            rounds={offlineTwoPlayer.rounds}
            onExit={() => setOfflineTwoPlayer(null)}
          />
        </main>
      </div>
    );
